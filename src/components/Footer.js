...
export default function Footer() {
  ...
  return (
    <MotionCard as="footer" className="footer" delay={0.35}>
      <div>© 2026 Lucas — codée avec <img src={heart.src} alt="heart" className="heart-img-footer" /> et beaucoup de <img src={latte.src} alt="Latte" className="coffee-img-footer" />.</div>
